...
line = LINE("EuDWR6ISwEdQVQ0xFHrf.4YSrMg2oNLZ3c2qS97Qi+W.2QNhSG1eXq+6tKvGU9AyMiQ3uGcZ7lccN16kNLf/nmg=")
...
#==============================================================================#                
			...
			ki1.sendContact(to, aisMID)
                        ...
                        ki5.sendContact(to, aisMID)
                        ki6.sendContact(to, ki2MID)
                        ki7.sendContact(to, ki3MID)
                        ki8.sendContact(to, ki4MID)
